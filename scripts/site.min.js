...
"use strict";var $=require("jquery");$(window).scroll(function(){$(window).scrollTop()>100?$(".page-header").addClass("sticky"):$(".page-header").removeClass("sticky")}),$(".fa-bars").click(function(){$(".text-menu").toggleClass("menu-appear")}),$("nav .text-menu a").click(function(){$(".text-menu").toggleClass("menu-appear")}),$("primary-nav a").click(function(e){var a=$(this).attr("href"),t=$(a).offset().top-70;$("html, body").animate({scrollTop:t},500),e.preventDefault()}),$(".coaches__coach").on("click",function(){$(this).siblings().removeClass("active"),$(this).toggleClass("active")});
