...
"use strict";var $=require("jquery");$(window).scroll(function(){$(window).scrollTop()>100?$(".page-header").addClass("sticky"):$(".page-header").removeClass("sticky")}),$(".mobile-toggle").click(function(){$(".page-header").hasClass("open-nav")?$(".page-header").removeClass("open-nav"):$(".page-header").addClass("open-nav")}),$(".main_h li a").click(function(){$(".page-header").hasClass("open-nav")&&($(".primary-nav").removeClass("open-nav"),$(".page-header").removeClass("open-nav"))}),$("primary-nav a").click(function(e){var a=$(this).attr("href"),s=$(a).offset().top-70;$("html, body").animate({scrollTop:s},500),e.preventDefault()}),$(".coaches__coach").on("click",function(){$(this).siblings().removeClass("active"),$(this).toggleClass("active")});
